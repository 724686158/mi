...
def init():
    ...
    try:
        db = MysqlHelper()
        sql = "insert into ECommerce(eCommerceId, eCommerceName, eCommerceUrl) values( 4, 'taobao', 'https://www.taobao.com');".encode(encoding='utf-8')
        db.insert(sql)
    ...
    try:
        ...
        print "加入cookie用户帐号信息成功"
    except Exception:
        print "加入cookie用户帐号信息失败"
