...
class Spider_taobao(RedisCrawlSpider):
    ...
    def processEcommerceGoodAndShopInformation(self, response):
        ...
        for eve in html['API.CustomizedApi']['itemlist']['auctions']:
            ...
            tempGoodItem['eCommerceName'] = self.name
            # 商品的数据
            ...
            tempGoodCommentItem['eCommerceName'] = self.name
            ...
            tempShopItem['eCommerceName'] = self.name
            ...
            tempShopCommentItem['eCommerceName'] = self.name
