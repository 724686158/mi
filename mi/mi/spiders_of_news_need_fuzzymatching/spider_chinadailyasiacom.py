...
class Spider_chinadailyasiacom(RedisCrawlSpider):
    name = 'chinadailyasia.com'
    redis_key = 'chinadailyasia.com:start_urls'
    allowed_domains = ['chinadailyasia.com']
    rules = [
        Rule(LinkExtractor(allow=('chinadailyasia.com'),deny=()),callback='processArticle',follow=True)
    ]
