...
class Spider_chinadailycomcn(RedisCrawlSpider):
    name = 'chinadaily.com.cn'
    redis_key = 'chinadaily.com.cn:start_urls'
    allowed_domains = ['chinadaily.com.cn']
    rules = [
        Rule(LinkExtractor(allow=('chinadaily.com.cn'),deny=()),callback='processArticle',follow=True)
    ]
