...
class Spider_peoplecomcn(RedisCrawlSpider):
    name = 'people.com.cn'
    redis_key = 'people.com.cn:start_urls'
    allowed_domains = ['people.com.cn']
    rules = [
        Rule(LinkExtractor(allow=('people.com.cn'),deny=()),callback='processArticle',follow=True)
    ]
